...
<form name="home" action="RetrieveHTML.php" method="POST">
...
if($num<1)
{
	echo "<br><br><h2 class=head1> No HTML questions</h2>";
	exit;
}
else
{
	echo "<h3 class=head1> HTML Session</h2><br/>";
	echo "<div align=left>";
	while($i<=$num)
	{
		echo "<table>";
		...
		echo "<tr><textarea autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' name='html$i' rows='8' cols='50'></textarea><tr>";
		echo "</table>";
		$i++;
	}
