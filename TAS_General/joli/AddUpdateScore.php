    ...
    <body>
        ...
        <div class="page-container">
                    ...
                    <li>
                       ...
                       <li class="xn-openable active">
                        ...
                        <ul>
							...
							<li class="active"><a href="AddUpdateScore.php"><span class="fa fa-pencil-square-o"></span> Evaluate Scores</a></li>
            ...
            <div class="page-content">
				...
				<iframe src="GeneralResult/index.php" height="1000px" width="1475px" style="position:relative;top:10%;"></iframe>
			</div>
