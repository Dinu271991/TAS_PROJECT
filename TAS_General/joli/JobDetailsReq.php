...
<html lang="en">
                        ...
                        <ul>
						   ...
						   <li><a href="ResultsPage.php"><span class="fa fa-check-square"></span> Result Page</a></li>
							...
							<li class="xn-openable active">
                             ...
                             <ul>
								<li class="active"><a href="JobDetailsReq.php"><span class="fa fa-info-circle"></span> Add Job Requirements</a></li>
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" name="JobForm" id="JobForm" method="post">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Add Job Requirements</strong></h3>
                                ...
                                <div class="panel-body">
									...
									<p>Elaborate job specification based on projects</p>
								</div>
                                <div class="panel-body">  
									...
									<?php
									    ...
									    echo "<input type=text name='postedBy' id='postedBy' value='$row[admin_name]' hidden/>"; 
										$date=date('Y-m-d');
										echo "<input type='text' id='postedDate' name='postedDate' value='$date' hidden/>";
									
									?>
									
                                        <label class="col-md-3 col-xs-12 control-label">Job Id</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
												<?php
													include_once 'dbconfig.php';
													$stmt5 = $db_con->prepare("SELECT * FROM tbl_qajobs");
													$stmt5->execute();
													...
													{
														$stmt5 = $db_con->prepare("SELECT max(Jobs_Id) FROM tbl_qajobs");
														$stmt5->execute();
														$row=$stmt5->fetch(PDO::FETCH_ASSOC);
														$jobId1=$row['max(Jobs_Id)']+1;
													}
												?>
                                                <input type="text" class="form-control" id="jobId" name="jobId" value="<?php echo $jobId1;?>" readonly/>
                                            </div>                                            
									...
									<div class="form-group">
									 ...
									 <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control select" name="projectName" id="projectName" placeholder="Select a Project Title">
									...
									<div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Number of Vacancy</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" id="noOfVacancy" name="noOfVacancy"/>
                                            </div>                                            
                                            <span class="help-block">Number of Vacancy</span>
                                        </div>
                                    </div>
									
									<div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Skillset</label>
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <input type="text" class="tagsinput" name="skills" id="skills"/>
                                            <span class="help-block">Place comma(,) after each skill</span>
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                             <select class="form-control select" name="yearOfExp" id="yearOfExp">
												<option value="Fresher">Fresher</option>
												<option value="0.6-1yrs">0.6-1yrs</option>
												<option value="1-3yrs">1-3yrs</option>
												<option value="3-5yrs">3-5yrs</option>
												<option value="5-8yrs">5-8yrs</option>
												<option value="8-10yrs">8-10yrs</option>
											 </select>
                                            <span class="help-block">Years of Experience</span>
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <textarea class="form-control"rows="10" id="jobDesc" name="jobDesc" style="resize:none;"></textarea>
									  ...
									  <div class="form-group">                                        
                                        <label class="col-md-3 col-xs-12 control-label">Closing Date</label>
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                <input type="text" class="form-control datepicker" value="<?php echo date('Y-m-d'); ?>" name="closingDate" id="closingDate">                                            
                                            </div>
                                ...
                                <div class="panel-footer">
                                    ...
                                    <button class="btn btn-primary pull-right" type="button" id="Save">Save Job Vacany Information</button>
                                </div>
                            </div>
                            </form>
    ...
    <!-- START SCRIPTS -->
		...
		$(document).ready(function(){
			...
			$('#Save').click(function(){
				$.post("tempAddJob.php",$("#JobForm").serialize(),function(response,status){ // Required Callback Function
				alert("Job Information has been submitted successfully!!");
				$('#clearForm').click();
