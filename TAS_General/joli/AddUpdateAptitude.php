    ...
    <body>
        ...
        <div class="page-container">
                                ...
                                <ul>
									<?php
										...
										while($row=$stmt4->fetch(PDO::FETCH_ASSOC))
										{
											...
											echo "<li id='$categoryName'><a href='AddUpdate$categoryName.php' id='AddUpdate$categoryName'><span class='fa fa-align-center'></span> $categoryName</a></li>";
											$categName[$i]='AddUpdate'.$categoryName;
											$i++;
            ...
            <div class="page-content">
				...
				<iframe src="Aptitude/AddApti.php" height="1000px" width="1475px" style="position:relative;top:0%;"></iframe>
			</div>
