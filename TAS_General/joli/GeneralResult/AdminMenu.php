...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
	 ...
	 <!-- <ul class="dropdown-menu">
          <li><a id="AptitudeResult">Aptitude</a></li>
          <li><a id="ProgramResult">Programming</a></li>
          <li><a id="EssayResult">Essay</a></li>
		  <li><a id="HtmlResult">Html</a></li>
		  <li><a id="GeneralResult">General</a></li>
        </ul>-->
	  
	  
	    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown">Requirement Form <span class="caret"></span></a>
	   <ul class="dropdown-menu">
          <li><a id="AddReqForm">Add Requirement Form</a></li>
          <li><a id="UpdateReqForm">Edit/Update Requirement Form</a></li>         
        </ul>	   
	   </li>
	   <li><a id="EvaluateScore">Evaluate Score</a></li>
      <li><a id="ResultPage">Result Page</a></li>
	  
	   <!--<li><a href="#" id="Notify">Notification</a></li>-->
    </ul>
	<ul class="nav navbar-nav navbar-right">
		<li class="dropdown">
       <a class="dropdown-toggle" data-toggle="dropdown" id="menu"><span class="label label-pill label-danger count1" style="border-radius:10px;"></span> <span class="glyphicon glyphicon-globe" style="font-size:18px;"></span></a>
       <ul class="dropdown-menu" id="menu1"></ul>
        <li><a ><span class="glyphicon glyphicon-user"><b>Hi,<?php echo $row['admin_name']; ?></b></span> </a></li> 
  ...
  <iframe src="../GeneralResult/index.php" id="GeneralScore" scrolling="yes" frameborder="0" style="border:none; overflow:hidden; width:100%;height:1000px;" allowTransparency="true"></iframe>
   ...
   <iframe src="../JobPosition/editJobDetails.php" id="editJobPost" scrolling="yes" frameborder="0" style="border:none; overflow:hidden; width:1000px;height:1000px;" allowTransparency="true"></iframe>
	...
	<!--Evaluate score           ../Evaluate_Score/index.php-->
	<iframe src="../Evaluate_Score/index.php" id="Evaluate" scrolling="yes" frameborder="0" style="border:none; overflow:hidden; width:100%;height:1000px;" allowTransparency="true"></iframe>
