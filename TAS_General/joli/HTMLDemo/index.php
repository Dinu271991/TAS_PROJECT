...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
	 ...
	 <li><a class="active" href="index.php">HTML</a></li>
	 <li><a href="../EssayDemo/index.php">Essay</a></li>
...
<br/><br/><br/><br/><br/>
	...
	<div class="container">
        ...
        <h2 class="form-signin-heading">HTML Records.</h2><hr />
        <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Add HTML Programs</button>
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View HTML Programs</button>
        <hr />
        ...
        $stmt = $db_con->prepare("SELECT * FROM tbl_html ORDER BY html_id DESC");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td align="center">
			<a id="<?php echo $row['html_id']; ?>" class="edit-link" href="#" title="Edit">
			<img src="edit.png" width="20px" />
            </a></td>
			<td align="center"><a id="<?php echo $row['html_id']; ?>" class="delete-link" href="#" title="Delete">
