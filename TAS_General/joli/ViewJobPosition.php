    ...
    <body>
        ...
        <div class="page-container">
                        ...
                        <ul>
							...
							<li><a href="ProjectDetails.php"><span class="fa fa-info-circle"></span> Add Project Information</a></li>
                             ...
                             <ul>
								...
								<li class="active"><a href="ViewJobPosition.php"><span class='fa fa-align-center'></span> Edit Job Requirements</a></li>
							</ul>
							</li>
            ...
            <div class="page-content">
				...
				<iframe src="JobDetails/editJobDetails.php" height="1000px" width="1500px" style="position:relative;top:10%;"></iframe>
			</div>
