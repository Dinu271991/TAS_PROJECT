    ...
    <body>
        ...
        <div class="page-container">
                       ...
                       <li class="xn-openable active">
                        ...
                        <ul>
						   ...
						   <li><a href="ResultsPage.php"><span class="fa fa-check-square"></span> Result Page</a></li>
							...
							<li class="active"><a href="EditUpdateProjectDetails.php"><span class="fa fa-info-circle"></span> View/Edit Project Details</a></li>
            ...
            <div class="page-content">
				...
				<iframe src="ProjectDetails/index.php" height="1000px" width="1475px" style="position:relative;top:10%;"></iframe>
			</div>
