    ...
    <body>
        ...
        <div class="page-container">
                    ...
                    <li class="active">
                      ...
                      <li class="xn-openable">
                        ...
                        <ul>
							...
							<li><a href=""><span class="fa fa-pencil-square-o"></span> Evaluate Scores</a></li>
							<li><a href=""><span class="fa fa-check-square"></span> Result Page</a></li>
							<li><a href=""><span class="fa fa-search-plus"></span> Job Requirements</a></li>
							<li><a href=""><span class="fa fa-info-circle"></span> Project Information</a></li>
							<li><a href=""><span class="fa fa-file-pdf-o"></span> Reports</a></li>
            ...
            <div class="page-content">
				...
				<iframe src="Programs/ProgramDemo.php" height="1000px" width="1500px" style="position:relative;top:10%;">
			</div>
