...
<div class="container">
   ...
   <?php 
	...
	<span style="position:fixed;top:75%;left:75px;font-size:1.5em;">Descriptive</span>
		...
		<!--<img src="images/Programming.png" data-toggle="modal" data-target="#Programming0" id="Programming" class="img-thumbnail" alt="Descriptive" border="0" height="200px" width="200px" style="position:absolute;left:30%;"/></img>;
		<img src="images/Essay.png" data-toggle="modal" data-target="#Essay0" id="Essay" class="img-thumbnail" alt="Descriptive" border="0" height="200px" width="200px" style="position:absolute;left:190%;"/></img>;
		<img src="images/Html.png" data-toggle="modal" data-target="#Html0" id="Html" class="img-thumbnail" alt="Descriptive" border="0" height="200px" width="200px" style="position:absolute;left:390%;"/></img>; -->
	...
	<?php
        ...
        //$automation=array("ViewChoice.php","Program.php","Essay.php","HTML.php");
			...
			while($row1=$stmt1->fetch(PDO::FETCH_ASSOC))
			{
				...
				echo "<img src=$imgCateg data-toggle=modal data-target=$modalTarget id=$strReplace class='img-thumbnail' alt='Descriptive' border='0' height='200px' width='200px' style='position:absolute;left:$n%;'/></img>";
