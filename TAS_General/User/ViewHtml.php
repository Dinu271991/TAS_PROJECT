...
<form name="home" action="HtmlSubmit.php" method="POST">
...
echo "You are in HTML Section<br/><br/>";
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
					    {		
							...
							<?php  
								echo $k." ".$row['html_desc']."<br/>"; ?>
								<textarea autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' rows='25' cols='50' name='html<?php echo $row['html_id'];?>' style='resize: none;'></textarea>
