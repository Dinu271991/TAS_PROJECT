...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2017 at 12:57 PM
...
(201, 1, 'a*b?', 'Prefix', 'Infix', 'Postfix', 'None of the above', 2),
...
(2147, 'admin1', 'admin@sun.com', '123456', 'Automation'),
(2148, 'admin2', 'admin2@sun.com', '123456', 'Automation'),
(2167, 'manualAdmin1', 'manualadmin1@sun.com', '123456', 'Manual'),
...
(104, 1, 'Name the different web browsers - atleast 3 or more? (Marks: 2)'),
...
(2, 'Yogi', 'Automation', '23456', 'Hyderabad', 'yogi@sun.com', '1234567876'),
...
(6, 'Ram', 'Manual', '123456', 'Mumbai', 'ram@sun.com', '9632587410'),
(7, 'Karhick', 'Development', '123456', 'Chennai', 'karthi@sun.com', '2345678901');
...
(102, 6, 'Does variable declaration affect memory allocation? (Marks: 2)');
...
(2220, 'John', 'Manual', 'john@gmail.com', '1234567');
...
(2345, 'ABC', 'xyz@sun.com', 123456),
(2346, 'MNO', 'mno@sun.com', 123456);
...
(101, 1, 'a*b?', 'Prefix', 'Infix.', 'Postfix', 'None of the above', 2),
...
(109, 1, 'Write a brief note on below topics not more than 5 sentences. (Marks: 5)\r\n\r\ni)Bank\r\n\r\nOR\r\n\r\nii) Insurance');
...
(106, 4, 'Write a query to select all the names starting with the value "J" from the below example table  Employee_Name? (Marks: 1)');
...
INSERT INTO `tbl_mcq_category` (`DeptId`, `category_id`, `category_name`) VALUES
(1, 101, 'Aptitude'),
(1, 102, 'Data_Structure'),
(1, 103, 'Programming'),
(1, 104, 'Browser_and_Internet'),
(1, 105, 'Mobile_Computing'),
(1, 106, 'SQL'),
(1, 107, 'Operating_System'),
(1, 108, 'General_Computing'),
(1, 109, 'Notes'),
(2, 201, 'Aptitude'),
(2, 202, 'Programming'),
(2, 203, 'Essay'),
...
(3, 302, 'Technical'),
(3, 303, 'Essay'),
(3, 304, 'Java_Progam_or_Algorithm');
...
(2, '2017-04-25 08:59:35', 3),
(3, '2017-04-11 00:00:00', 4),
(5, '2017-04-12 00:00:00', 4),
(6, '2017-04-20 13:55:13', 2);
...
CREATE TABLE `tbl_useressays` (
  ...
  `essay_desc` varchar(1000) NOT NULL,
...
CREATE TABLE `tbl_userhtml` (
  `uid` int(3) NOT NULL,
  `html_id` int(3) NOT NULL,
  `html_desc` varchar(1000) NOT NULL,
...
CREATE TABLE `tbl_userprogram` (
  `uid` int(3) NOT NULL,
  `program_id` int(3) NOT NULL,
  `prog_desc` varchar(100) NOT NULL,
...
(6, 1, '', 0),
(6, 2, '', 0),
(6, 3, 'hhhhhhhhhhhhhhhhhhhhhhhhhhh', 0),
(6, 4, '', 0),
(6, 5, '', 0),
(6, 6, '', 0);
...
(6, 1, 'bbbbbbbbbbbbb', 0),
(6, 2, 'aaaaaaaaaaa', 0),
(6, 3, 'cccccccccccccc', 0),
(6, 4, 'eeeeeeeeeeeeeee', 0),
(6, 5, 'ddddddddddddddd', 0),
(6, 6, 'ffffffffffffffffffffffff', 0);
...
(6, 1, 'xxxxxxxxxxxxxxxxxxxxxxx', 0),
(6, 2, 'cccccccccccccccccccccc', 0),
(6, 3, 'nnnnnnnnnnnnnnn', 0),
(6, 4, 'zzzzzzzzzzzzzzzz', 0),
(6, 5, 'bbbbbbbbbbbbbbbbbb', 0),
(6, 6, 'mmmmmmmmmmmm', 0),
(6, 7, 'vvvvvvvvvvvvvvvvvvvvv', 0),
...
(6, 1, 'zzzzzzzzzzzz', 0),
(6, 2, 'xxxxxxxxxxxxxxxxxx', 0),
(6, 3, 'bbbbbbbbbbbb', 0),
(6, 4, 'vvvvvvvvvvvv', 0),
(6, 5, 'cccccccccccccc', 0);
...
(6, 1, 'gggggggggggggg', 0),
(6, 2, 'kkkkkkkkkkkkkkkk', 0),
(6, 3, 'jjjjjjjjjjjjjjjj', 0),
(6, 4, 'hhhhhhhhhhhhh', 0),
(6, 5, 'ffffffffffffffffffffff', 0),
(6, 6, 'llllllllllllllllll', 0);
...
(6, 1, 'iiiiiiiiiiiiiiiiii', 0),
(6, 2, 'tttttttttttttt', 0),
(6, 3, 'yyyyyyyyyyyyyyyy', 0),
(6, 4, 'uuuuuuuuuuuuuuuuuu', 0);
