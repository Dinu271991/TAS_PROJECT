...
<form name="home" id="myFrm" action="HtmlSubmit.php" method="POST">
		...
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
					    {		
							...
							<?php  
								...
								<textarea autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' rows='15' cols='100' name='html<?php echo $row['html_id'];?>' style='resize: none;'></textarea>
								<br/><br/>							
								</div> 
						<?php 
								  $i++; 
