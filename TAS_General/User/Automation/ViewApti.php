...
<?php
	...
	echo "<span id='maxQuest' style=position:relative;right:-200px;>No of Quest:: ".$rowcount."</span><br/><br/>";
						...
						while($row=$stmt->fetch(PDO::FETCH_ASSOC))
					    {
							...
							<?php 
								 ...
								 if ( ( $remainder < 1 ) || ( $i == $number_question && $remainder == 1 ) ) {
								 	...
								 	echo "<button id='".$j."' class='next btn btn-primary' type='submit'>Final Submit</button>";
