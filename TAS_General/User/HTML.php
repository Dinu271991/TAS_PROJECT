...
//echo "You are in HTML Section<br/><br/>";
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
					    {		
							...
							<?php  
								echo "<br/>".$k." ".$row['html_desc']."<br/>"; ?>
								<textarea autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' rows='15' cols='100' id='html<?php echo $row['html_id'];?>' name='html<?php echo $row['html_id'];?>' style='resize: none;'></textarea>
								<br/><br/>							
								</div> 
						<?php 
								  $i++; 
