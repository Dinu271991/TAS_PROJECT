...
<form name="home" action="EssaySubmit.php" method="POST">
...
echo "You are in Essay Section<br/><br/>";	
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
					    {		
							...
							<?php  
								echo $k." ".$row['essay_desc']."<br/>"; ?>
								<textarea autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' rows='25' cols='50' name='essay<?php echo $row['essay_id'];?>' style='resize: none;'></textarea>
						...
						<?php 
								 ...
								 if ( ( $remainder < 1 ) || ( $i == $number_question && $remainder == 1 ) ) {
								 	...
								 	echo "<button id='".$j."' class='next btn btn-primary' type='submit' style=position:relative;top:70px>Final Submit</button>";
								 	echo "</div>";
