...
<div class="container">
   ...
   <?php 
	...
	<ul class="nav nav-pills nav-stacked" style="postion:fixed;color:green;"> 
	 ...
	 <li><img src="images/mcq.png" id="mcq" class="options" alt="Multiple Choice" border="0" height="200px" width="200px" style="position:fixed;top:10%;"/></img></li><br/>
	 <span style="position:fixed;top:35%;left:75px;font-size:1.5em;">Multiple Choice</span>
     <li><img src="images/descriptive.png" class="options" id="descriptive"  alt="Descriptive" border="0" height="200px" width="200px" style="position:fixed;top:50%;"/></img></li><br/>
	<span style="position:fixed;top:75%;left:75px;font-size:1.5em;">Descriptive</span>
		...
		?>
	   <div id="iframeSections" style="position:absolute;left:50%">
				<iframe src="<?php echo "$deptPage";?>" class="aptitude" id="<?php echo "$categName";?>" scrolling="yes" frameborder="0" style="border:none;top:-100px;width:1000px;height:100%; allowTransparency=true""></iframe>
        ...
        //$automation=array("ViewChoice.php","Program.php","Essay.php","HTML.php");
			...
			while($row1=$stmt1->fetch(PDO::FETCH_ASSOC))
			{
				...
				echo "<ul>";
				echo "<img src=$imgCateg data-toggle=modal data-target=#myModal id=$row1[category_name] class='img-thumbnail' alt=Descriptive border=0 height=200px width=200px style=position:absolute;left:$n%;/></img>";
				//echo "<button class='descriptive' id=$row1[category_name] style='position:relative;top:-50px'></button>"."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				echo "</ul>";
	...
	<!--	<div id="christmas_promotion_boxes">
            <div id="christmas_promo_1">
                <img src="images/Html.png" width="200px" height="200px" style="position:absolute;left:30%;">
            </div>
            <div id="christmas_promo_2">
            <img src="images/Programming.png" width="200px" height="200px" style="position:absolute;left:140%;">
            </div>
            <div id="christmas_promo_3">
                <img src="images/Essay.png" width="200px" height="200px" style="position:absolute;left:250%;">
            </div>
        </div> -->
		...
		/*$strReplace=str_replace("_"," ",$row['category_name']);
			echo "<li><a href=# id=$row[category_name] class=autoCateg><span style=font-size:1.3em;>$strReplace</span></a></li>";
	...
	<?php
		...
		{
			?>
			 <iframe src="<?php echo "$deptPage1[$k]";?>" class="sections" id="<?php echo "$categName1[$k]"."0";?>" scrolling="yes" frameborder="0" style="border:none;top:-100px;width:1000px;height:100%; allowTransparency=true" onload="resizeIframe(this)"></iframe>
			<?php 
			$k=$k+1;
		}
...
<!--<form method="post" action="FinalSubmit.php">
 ...
 <!-- <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" style="position:absolute;top:50%;left:50%;">
  <span >  Launch demo modal
  </button> -->
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
		  ...
		  <div class="modal-body">
		   ...
		   <iframe class="demo2" scrolling="yes" frameborder="0" style="border:none;top:30%;width:100%;height:100%;" allowTransparency="true"></iframe>
		  <?php
