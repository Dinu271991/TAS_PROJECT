...
<button id="Done" name="Done" class='btn btn-danger' style="position:fixed;top:13%;right:0%" onClick="myFunction();">Abort Test</button>
...
<div class="container">
   ...
   <?php 
		...
		?>
	<span style="position:fixed;top:15%;left:75px;font-size:1.9em;color:#0f4f5a"><b><u>Sections</u></b></span>
	<span style="position:fixed;top:15%;left:45%;font-size:1.9em;color:#0f4f5a" class="subsections"><b><u>Sub Sections</u></b></span>
		<div class="col-lg-2">
    ...
    <!--<span style="position:fixed;top:12%;left:75px;font-size:1.9em;"><u>Sections</u></span>-->
  	 ...
  	 <li><img src="images/mcq.png" id="mcq" class="options" alt="Multiple Choice" border="0" height="200px" width="200px" style="position:fixed;top:20%;"/><span id="mcq" style="position:fixed;top:42%;left:71px;font-size:1.5em;color:maroon;">Multiple Choice</span></img></li><br/>
	 <!--<span style="position:fixed;top:37%;left:75px;font-size:1.5em;">Multiple Choice</span>-->
     <li><img src="images/descriptive.png" class="options" id="descriptive"  alt="Descriptive" border="0" height="200px" width="200px" style="position:fixed;top:55%;"/><span id="descriptive" style="position:fixed;top:78%;left:75px;font-size:1.5em;color:maroon;">Descriptive</span></img></li><br/>
		...
		require_once 'dbconfig.php';
            ...
            //$automation=array("ViewChoice.php","Program.php","Essay.php","HTML.php");
			$stmt1 = $db_con->prepare("SELECT * FROM tbl_mcq_category where DeptId=3");
			$stmt1->execute();
			$j=0;	
			$nMCQ=20;
			$topMCQ=0;
			...
			while($row1=$stmt1->fetch(PDO::FETCH_ASSOC))
			{
				...
				if($row1["category_type"]=="Descriptive")
				{
					$nMCQ+=18;
					$topMCQ=30;
					echo "<img src=$imgCateg class='descr' data-toggle=modal data-target=$modalTarget id=$strReplace alt='Multiple Choice' border='0' height='300px' width='300px' style='position:fixed;top:$topMCQ%;left:$nMCQ%;'/></img>";
			   	}
				else
				{
					$nDesc+=18;
					$topDesc=30;
					echo "<img src=$imgCateg class='multiplechoice' data-toggle=modal data-target=$modalTarget id=$strReplace alt='Descriptive' border='0' height='300px' width='300px' style='position:fixed;top:$topDesc%;left:$nDesc%;'/></img>";
