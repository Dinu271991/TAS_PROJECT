...
<?php
	...
	$stmt = $db_con->prepare("SELECT * FROM tbl_development_aptitude ORDER BY rand()");
	...
	<form class="form-horizontal" role="form" id='quiz_form' method="post" action="AptiSubmit.php">
						<?php
