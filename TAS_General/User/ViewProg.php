...
<form name="home" action="ProgSubmit.php" method="POST">
...
echo "You are in Programming Section<br/><br/>";
		...
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
					    {		
							...
							<?php  
								echo "<br/><br/><br/>".$k." ".$row['prog_desc']."<br/>"; ?>
								<textarea autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' rows='25' cols='100' name='prog<?php echo $row['program_id'];?>' style='resize: none;'></textarea>
							...
							<?php 
								 ...
								 if ( ( $remainder < 1 ) || ( $i == $number_question && $remainder == 1 ) ) {
								 	...
								 	echo "<button id='".$j."' class='next btn btn-primary' type='submit' style=position:relative;>Final Submit</button>";
								 	echo "</div>";
