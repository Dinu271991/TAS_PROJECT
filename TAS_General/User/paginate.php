...
echo "<tr><th colspan='6'><br/><hr width='100%'></th><tr>"; 
	...
	/*echo '<tr><td>'.$row['0'].'.'.$row['1'].'</td></tr>'.'<tr><td>'.'
	<input type=radio name="ans$i"  value=1 checked="checked">'.$row['2'].'&nbsp;&nbsp;&nbsp;&nbsp;'.'</td><td>'.'<input type=radio name="ans$i"  value=2>'.$row['3']
	.'</td></tr><tr><td>'.'<input type=radio name="ans$i"  value=3>'.$row['4'].'&nbsp;&nbsp;&nbsp;&nbsp;'.'</td><td>'.'<input type=radio name="ans$i"  value=4>'.$row['5'].'</td>'.'</tr>'.'<br/>';
	echo "<tr><th colspan='6'><br/><hr width='100%'></th><tr>";*/
