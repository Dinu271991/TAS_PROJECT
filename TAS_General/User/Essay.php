...
//echo "You are in Essay Section<br/><br/>";	
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
					    {		
							...
							<?php  
								echo "<br/>".$k." ".$row['essay_desc']."<br/>"; ?>
								<textarea autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' rows='15' cols='100' id='essay<?php echo $row['essay_id'];?>' name='essay<?php echo $row['essay_id'];?>' style='resize: none;'></textarea>
								<br/><br/>							
								</div> 
						<?php 
								  $i++; 
