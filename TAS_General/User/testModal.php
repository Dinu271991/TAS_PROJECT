...
<div class="container">
   ...
   <?php 
	...
	<ul class="nav nav-pills nav-stacked" style="postion:fixed;color:green;"> 
	 ...
	 <li><img src="images/mcq.png" id="mcq" class="img-circle" alt="Multiple Choice" border="0" height="200px" width="200px" style="position:fixed;top:10%;"/></img></li><br/>
	 <span style="position:fixed;top:35%;left:75px;font-size:1.5em;">Multiple Choice</span>
     <li><img src="images/descriptive.png" id="descriptive" class="img-circle" alt="Descriptive" border="0" height="200px" width="200px" style="position:fixed;top:50%;"/></img></li><br/>
	<span style="position:fixed;top:75%;left:75px;font-size:1.5em;">Descriptive</span>
	   ...
	   <div id="iframeSections" style="position:absolute;left:50%">
				<iframe src="<?php echo "$deptPage";?>" class="aptitude" id="<?php echo "$categName";?>" scrolling="yes" frameborder="0" style="border:none;top:-100px;width:1000px;height:100%; allowTransparency=true" onload="resizeIframe(this)"></iframe>
        ...
        //$automation=array("ViewChoice.php","Program.php","Essay.php","HTML.php");
			...
			while($row1=$stmt1->fetch(PDO::FETCH_ASSOC))
			{
				...
				echo "<ul>";
				echo "<img src=$imgCateg id=$row1[category_name] class='img-thumbnail' alt=Descriptive border=0 height=200px width=200px style=position:absolute;left:$n%;/></img>";
  ...
  <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document" style="position:absolute;top:15%;left:18%;width:80%;">
      <div class="modal-content">
		...
		Click me
           <iframe src="Aptitude.php" class="demo2" scrolling="yes" frameborder="0" style="border:none;top:30%;width:100%;height:30%; allowTransparency=true" onload="resizeIframe(this)"></iframe>
