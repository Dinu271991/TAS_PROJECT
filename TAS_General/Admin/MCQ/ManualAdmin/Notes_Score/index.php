...
<body>
	...
	<div class="container">
        ...
        <h2 class="form-signin-heading">User Notes/Essay Records.</h2><hr />
        ...
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View User Notes/Essay Scores</button>
        ...
        <tr>
        <th>User Id</th>
        <th>Notes/Essay Id</th>
        <th>Notes/Essay Description</th>
        <th>Score</th>
        ...
        $stmt = $db_con->prepare("SELECT * FROM tbl_user_notes ORDER BY uid DESC");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td><?php echo $row['notes_score']; ?></td>

			<td align="center">
			<a id="<?php echo $row['uid'];?>"  class="edit-link" href="#" title="<?php echo $row['notes_id'];?>">
