...
<body>
	...
	<div class="container">
        ...
        <h2 class="form-signin-heading">User Mobile Computing Records.</h2><hr />
        ...
        $stmt = $db_con->prepare("SELECT * FROM tbl_user_mobile_computing ORDER BY uid DESC");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td><?php echo $row['mc_desc']; ?></td>
			<td><?php echo $row['mc_score']; ?></td>

			<td align="center">
			<a id="<?php echo $row['uid'];?>"  class="edit-link" href="#" title="<?php echo $row['mc_id'];?>">
