...
<body>
	...
	<div class="container">
        ...
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View User Programming Scores</button>
        ...
        <tr>
        <th>User Id</th>
        <th>Programming Id</th>
        <th>Programming Description</th>
        <th>Score</th>
        ...
        $stmt = $db_con->prepare("SELECT * FROM tbl_user_manual_program ORDER BY uid DESC");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td><?php echo $row['prog_score']; ?></td>

			<td align="center">
			<a id="<?php echo $row['uid'];?>"  class="edit-link" href="#" title="<?php echo $row['prog_id'];?>">
