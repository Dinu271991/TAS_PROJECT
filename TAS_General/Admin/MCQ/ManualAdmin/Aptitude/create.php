...
require_once '../dbconfig.php';
	...
	if($_POST)
	{
		...
		try{
			...
			$stmt = $db_con->prepare("INSERT INTO tbl_manual_aptitude(qid,qdesc,option1,option2,option3,option4,answer) VALUES(:qid, :qdesc, :option1, :option2,:option3,:option4,:answer)");
