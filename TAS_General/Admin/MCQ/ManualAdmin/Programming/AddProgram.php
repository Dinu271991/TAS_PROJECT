...
<body>
	...
	<div class="container">
        ...
        <h2 class="form-signin-heading">Manual Program Records.</h2><hr />
        ...
        $stmt = $db_con->prepare("SELECT * FROM tbl_manual_programming ORDER BY prog_id DESC");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td align="center">
			<a id="<?php echo $row['prog_id']; ?>" class="edit-link" href="#" title="Edit">
