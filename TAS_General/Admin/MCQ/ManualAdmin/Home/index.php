...
<body>
	...
	<div class="container">
        ...
        <h2 class="form-signin-heading">Cutoff Scores</h2><hr />
        ...
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View Cutoff Scores</button>
        ...
        $stmt = $db_con->prepare("SELECT * FROM tbl_dept_cutoff");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td align="center">
			<a id="<?php echo $row['DeptId'];?>"  class="edit-link" href="#" title="<?php echo $row['DeptId'];?>">
