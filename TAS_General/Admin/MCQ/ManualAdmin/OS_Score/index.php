...
<body>
	...
	<div class="container">
        ...
        <h2 class="form-signin-heading">User OS Records.</h2><hr />
        ...
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View OS Scores</button>
        ...
        $stmt = $db_con->prepare("SELECT * FROM tbl_user_os ORDER BY uid DESC");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td><?php echo $row['os_score']; ?></td>

			<td align="center">
			<a id="<?php echo $row['uid'];?>"  class="edit-link" href="#" title="<?php echo $row['os_id'];?>">
