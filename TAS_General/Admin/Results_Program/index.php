...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
		 ...
		 <ul class="sidenav">
     <li><a href="../MCQ/index.php">Aptitude</a></li>
     <li><a  href="../MCQ/Programs/index.php">Programming</a></li>
	 <li><a href="../MCQ/HTMLDemo/index.php">HTML</a></li>
	 <li><a href="../MCQ/EssayDemo/index.php">Essay</a></li>
    <li><a href="index.php" class="active">Programming Scores</a></li>
	...
	<div class="container">
        ...
        <h2 class="form-signin-heading">User Programming Records.</h2><hr />
        ...
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View Programming Scores</button>
        ...
        $stmt = $db_con->prepare("SELECT * FROM tbl_userprogram ORDER BY uid DESC");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td><?php echo $row['prgm_score']; ?></td>

			<td align="center">
			<a id="<?php echo $row['uid'];?>"  class="edit-link" href="#" title="<?php echo $row['program_id'];?>">
