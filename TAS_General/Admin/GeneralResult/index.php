...
<body>
	...
	<div class="container">
        ...
        <h2 class="form-signin-heading">Candidate Score Records.</h2><hr />
       <!-- <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Add Essay Scores</button>-->
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View Candidate Scores</button>
        <hr />
