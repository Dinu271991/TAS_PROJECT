...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
	...
	<li><a href="index.php" class="active">Essay Scores</a></li>
	...
	<div class="container">
        ...
        <h2 class="form-signin-heading">User Essay Records.</h2><hr />
       <!-- <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Add Essay Scores</button>-->
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View Essay Scores</button>
        <hr />
        ...
        $stmt = $db_con->prepare("SELECT * FROM tbl_useressays ORDER BY uid DESC");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td><?php echo $row['essay_score']; ?></td>

			<td align="center">
			<a id="<?php echo $row['uid'];?>"  class="edit-link" href="#" title="<?php echo $row['essay_id'];?>">
