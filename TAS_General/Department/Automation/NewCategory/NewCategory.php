...
$(document).ready(function () {
	 ...
	 alert("Directory value from php: "+dirPhp);
...
$("#Save").click(function(){
$.post(dirPhp+"TempSave.php",$("#myFrm").serialize(),function(response,status){ // Required Callback Function
		...
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
						...
						<?php 
								 ...
								 if ( ( $remainder < 1 ) || ( $i == $number_question && $remainder == 1 ) ) {
									echo "<button id='Save' class='save' type='button' style=position:fixed;top:50%;left:93%;>Save <i class='fa fa-floppy-o' aria-hidden='true'></i></button>";
