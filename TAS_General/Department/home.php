...
$stmt8 = $db_con->prepare("SELECT * FROM tbl_dept");
$stmt8->execute();

while($row8=$stmt8->fetch(PDO::FETCH_ASSOC))
{
	if($row8['DeptName']==$row['department'])
	{
		$_SESSION['Dept']=$row8['DeptId'];
		$_SESSION['DeptName']=$row8['DeptName'];
	}
...
/*if($row['department']=='Manual')
{
	$_SESSION['Dept']=1;
	//header("Location: Manual/home.php");
	
}
else if($row['department']=='Development')
{
	$_SESSION['Dept']=3;
	//header("Location: ../User/Development/home.php");
...
<form class="form">
 <button type="submit" name="btn-test" id="btn-test" class="btn btn-success" style="position:fixed;height:5%;">
    		Start Test</span>
			</button> 
...
<center>
<h1><u class="instructions" id="instnText" style="color:black;font-size:30px;">Instructions</u></h1><br/>
</center>
	<li>Time allocated for the test is 2 hours.</li><br/>
	<li>Plan your time such that all the questions are attempted, upon your first click on any subsections under ( Mutliple Choice or Descriptive) section, the <strong id="info">Time Starts</strong>.</li><br/>
	...
	<li>Review all of your answers before clicking on Final Submit.</li><br/>
	<li><span style="color:#632020;"><b>DO NOT </b></span><img src="refresh.gif" height="30px" width="40px"></img>(Refresh) the browser or click on <img src="back.png" height="20px" width="30px"></img> (Back) button of the browser, as this will take you out of the test.  </li>


	<li style="padding-top:35px;">If you have read the above instructions, Click on Start Test button which is located at the top right.</li>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
		  ...
		  <?php
				...
				echo " <iframe src='AutomationCandidate.php' class=demo2 scrolling=yes frameborder=0 style=border:none;top:30%;width:100%;height:100%; allowTransparency=true></iframe>";
