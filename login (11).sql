...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2017 at 10:43 AM
...
(114, 2147, 'Automation', 'Selenium Engineer', 6, '2y-5y', 'aqaqaqaaq', 'Open', '2017-04-14 14:07:30', 1, 1, '2017-06-12 12:56:52', 0),
...
(1, 'FHLB-NY', 1, 5, '2017-06-01', 0, NULL),
(2, 'Havertys', 1, 3, '2017-05-25', 0, NULL),
(3, 'ATLANTA', 1, 3, '2017-05-18', 0, NULL),
(4, 'ZIPLOC', 0, 2, '2017-06-01', 1, '2017-06-02');
...
--
-- Table structure for table `tbl_automation_`
--

CREATE TABLE `tbl_automation_` (
  `_id` int(6) UNSIGNED NOT NULL,
  `_desc` text NOT NULL,
  `_score` int(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `tbl_automation_abc`
--

CREATE TABLE `tbl_automation_abc` (
  `ABC_id` int(6) UNSIGNED NOT NULL,
  `ABC_desc` text NOT NULL,
  `ABC_score` int(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `tbl_automation_appium_mcq`
--

CREATE TABLE `tbl_automation_appium_mcq` (
  `Appium_MCQ_id` int(6) UNSIGNED NOT NULL,
  `Appium_MCQ_desc` text NOT NULL,
  `option1` text,
  `option2` text,
  `option3` text,
  `option4` text,
...
--
-- Table structure for table `tbl_automation_maven_mcq`
--

CREATE TABLE `tbl_automation_maven_mcq` (
  `Maven_MCQ_id` int(6) UNSIGNED NOT NULL,
  `Maven_MCQ_desc` text NOT NULL,
  `option1` text,
  `option2` text,
  `option3` text,
  `option4` text,
...
--
-- Dumping data for table `tbl_automation_maven_mcq`
--

INSERT INTO `tbl_automation_maven_mcq` (`Maven_MCQ_id`, `Maven_MCQ_desc`, `option1`, `option2`, `option3`, `option4`, `answer`) VALUES
(1, 'xvzg', 'xVZf', 'vXZd', 'VXZs', 'ZVXa', 3);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_automation_mcq`
--

CREATE TABLE `tbl_automation_mcq` (
  `MCQ_id` int(6) UNSIGNED NOT NULL,
  `MCQ_desc` text NOT NULL,
  `option1` text,
  `option2` text,
  `option3` text,
  `option4` text,
...
--
-- Dumping data for table `tbl_automation_mcq`
--

INSERT INTO `tbl_automation_mcq` (`MCQ_id`, `MCQ_desc`, `option1`, `option2`, `option3`, `option4`, `answer`) VALUES
(1, 'FDFDSA', 'FDSA', 'FASD', 'FASD', 'FSDA', 1),
(2, 'DGFSFDSAF', 'FDSA', 'FDSA', 'FDSA', 'FDSA', 2),
(3, 'FGDS', 'GFD', 'SGDF', 'GDFS', 'GDSF', 3),
(4, 'FDASFDSA', 'QWQ', 'DSA', 'CX', 'FS', 4);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_automation_newcategory`
--

CREATE TABLE `tbl_automation_newcategory` (
  `NewCategory_id` int(6) UNSIGNED NOT NULL,
  `NewCategory_desc` text NOT NULL,
  `NewCategory_score` int(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_automation_newcategory`
--

INSERT INTO `tbl_automation_newcategory` (`NewCategory_id`, `NewCategory_desc`, `NewCategory_score`) VALUES
(1, 'abc', 0),
(2, 'qwerty', 0),
(3, 'poiuy', 0);
...
--
-- Table structure for table `tbl_automation_qtp_mcq`
--

CREATE TABLE `tbl_automation_qtp_mcq` (
  `QTP_MCQ_id` int(6) UNSIGNED NOT NULL,
  `QTP_MCQ_desc` text NOT NULL,
  `QTP_MCQ_score` int(6) NOT NULL,
  `option1` text,
  `option2` text,
  `option3` text,
  `option4` text,
...
--
-- Table structure for table `tbl_automation_ranorex_mcq`
--

CREATE TABLE `tbl_automation_ranorex_mcq` (
  `Ranorex_MCQ_id` int(6) UNSIGNED NOT NULL,
  `Ranorex_MCQ_desc` text NOT NULL,
  `option1` text,
  `option2` text,
  `option3` text,
  `option4` text,
...
--
-- Dumping data for table `tbl_automation_ranorex_mcq`
--

INSERT INTO `tbl_automation_ranorex_mcq` (`Ranorex_MCQ_id`, `Ranorex_MCQ_desc`, `option1`, `option2`, `option3`, `option4`, `answer`) VALUES
(1, 'ABC?', 'cxZ', 'zCX', 'CZX', 'cZX', 2);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_automation_samplefile`
--

CREATE TABLE `tbl_automation_samplefile` (
  `SampleFile_id` int(6) UNSIGNED NOT NULL,
  `SampleFile_desc` text NOT NULL,
  `SampleFile_score` int(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_automation_samplefile`
--

INSERT INTO `tbl_automation_samplefile` (`SampleFile_id`, `SampleFile_desc`, `SampleFile_score`) VALUES
(1, 'What is WAP ? Also explain what it is used for.', 0);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_automation_selenium`
--

CREATE TABLE `tbl_automation_selenium` (
  `Selenium_id` int(6) UNSIGNED NOT NULL,
  `Selenium_desc` text NOT NULL,
  `Selenium_score` int(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_automation_selenium`
--

INSERT INTO `tbl_automation_selenium` (`Selenium_id`, `Selenium_desc`, `Selenium_score`) VALUES
(1, 'dfas', 0),
(2, 'sadda', 0),
(3, 'AAAAAAAAAAAAAAAAAAAAAAAAAAAA', 0),
(4, 'XZcC', 0),
(5, 'ASFDFADS', 0),
(6, 'zccxz', 0),
(7, 'ZCXXZ', 0),
...
--
-- Table structure for table `tbl_automation_selenium_mcq`
--

CREATE TABLE `tbl_automation_selenium_mcq` (
  `Selenium_MCQ_id` int(6) UNSIGNED NOT NULL,
  `Selenium_MCQ_desc` text NOT NULL,
  `option1` text,
  `option2` text,
  `option3` text,
  `option4` text,
...
--
-- Dumping data for table `tbl_automation_selenium_mcq`
--

INSERT INTO `tbl_automation_selenium_mcq` (`Selenium_MCQ_id`, `Selenium_MCQ_desc`, `option1`, `option2`, `option3`, `option4`, `answer`) VALUES
(1, 'fxzs', 'fsd', 'fdsa', 'fdsa', 'dafs', 3),
(2, 'asdf', 'fads', 'afds', 'afds', 'dfas', 2),
(3, 'fa', 'fads', 'FASDfa', 'afsd', 'afds', 2);
...
--
-- Table structure for table `tbl_candidatefinalstatus`
--

CREATE TABLE `tbl_candidatefinalstatus` (
  `user_id` int(5) NOT NULL,
  `user_name` varchar(40) NOT NULL,
  `refresh_count` int(3) NOT NULL,
  `status` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_candidatefinalstatus`
--

INSERT INTO `tbl_candidatefinalstatus` (`user_id`, `user_name`, `refresh_count`, `status`) VALUES
(2, 'a', 0, 'Aborted');
...
INSERT INTO `tbl_exp` (`Exp_Id`, `No_of_Exp`) VALUES
(0, ''),
(1, 'Fresher'),
(2, '0 to less than or equal to 1 yr');
...
INSERT INTO `tbl_programs` (`category_id`, `program_id`, `prog_desc`, `prog_score`) VALUES
(102, 1, 'WAP to check whether  a string is Palindrome?', 5),
(102, 2, 'WAP to check vowels exist in String or not?', 5),
(102, 3, 'WAP to generate numbers from 1 to 10 without loops', 5),
(102, 4, 'WAP to check whether a number is factorial result?', 10),
(102, 5, 'WAP to extract numbers from a string??', 10);
...
(2, 'Openings for Selenium Engineer', 'Havertys', 'Senior QA', 54, 'Java,Maven', '3yrs+', 'Mandatory skills in Maven Framework', 0, '2017-06-08', '2017-06-12', 'admin1'),
(3, 'cvcv', 'FHLB-NY', 'vcxcvxz', 6, 'C++,Java,C#', 'Fresher', 'fgfgdgfdgfd', 0, '2017-06-08', '2017-06-08', 'admin1'),
(4, 'hft', 'xdgd', 'hfg', 5, 'Java,Selenium,c#', '0.6-1yrs', 'dgdf', 0, '2017-06-09', '2017-06-15', 'admin1');
...
(2, '2017-06-15 14:31:15', 1),
(3, '2017-04-11 00:00:00', 4),
(5, '2017-04-12 00:00:00', 4),
(6, '2017-06-15 11:43:14', 0),
(7, '2017-06-15 11:21:52', 0);
...
--
-- Table structure for table `tbl_user_automation_mcq`
--

CREATE TABLE `tbl_user_automation_mcq` (
  `uid` int(6) DEFAULT NULL,
  `MCQ_id` int(6) DEFAULT NULL,
  `candidateAnswer` int(6) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_user_automation_mcq`
--

INSERT INTO `tbl_user_automation_mcq` (`uid`, `MCQ_id`, `candidateAnswer`) VALUES
(2, 1, 4),
(2, 2, 1),
(2, 3, 2),
(2, 4, 4);
...
--
-- Table structure for table `tbl_user_automation_mcq_result`
--

CREATE TABLE `tbl_user_automation_mcq_result` (
  `uid` int(6) UNSIGNED NOT NULL,
  `score` int(6) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_user_automation_mcq_result`
--

INSERT INTO `tbl_user_automation_mcq_result` (`uid`, `score`) VALUES
(2, 1);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_user_automation_newcategory`
--

CREATE TABLE `tbl_user_automation_newcategory` (
  `uid` int(6) DEFAULT NULL,
  `NewCategory_id` int(6) DEFAULT NULL,
  `NewCategory_desc` text,
  `NewCategory_score` int(6) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_user_automation_newcategory`
--

INSERT INTO `tbl_user_automation_newcategory` (`uid`, `NewCategory_id`, `NewCategory_desc`, `NewCategory_score`) VALUES
(2, 1, 'gdsf', 0),
(2, 2, 'sdfg', 0),
(2, 3, 'gfds', 0),
(0, 1, 'fgh', 0),
...
--
-- Table structure for table `tbl_user_automation_selenium_mcq`
--

CREATE TABLE `tbl_user_automation_selenium_mcq` (
  `uid` int(6) DEFAULT NULL,
  `Selenium_MCQ_id` int(6) DEFAULT NULL,
  `candidateAnswer` int(6) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `tbl_user_automation_selenium_mcq_result`
--

CREATE TABLE `tbl_user_automation_selenium_mcq_result` (
  `uid` int(6) NOT NULL,
  `finalScore` int(6) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indexes for table `tbl_automation_`
--
ALTER TABLE `tbl_automation_`
  ADD PRIMARY KEY (`_id`);

--
-- Indexes for table `tbl_automation_abc`
--
ALTER TABLE `tbl_automation_abc`
  ADD PRIMARY KEY (`ABC_id`);

--
-- Indexes for table `tbl_automation_appium_mcq`
--
ALTER TABLE `tbl_automation_appium_mcq`
  ADD PRIMARY KEY (`Appium_MCQ_id`);

--
-- Indexes for table `tbl_automation_maven_mcq`
--
ALTER TABLE `tbl_automation_maven_mcq`
  ADD PRIMARY KEY (`Maven_MCQ_id`);

--
-- Indexes for table `tbl_automation_mcq`
--
ALTER TABLE `tbl_automation_mcq`
  ADD PRIMARY KEY (`MCQ_id`);

--
-- Indexes for table `tbl_automation_newcategory`
--
ALTER TABLE `tbl_automation_newcategory`
  ADD PRIMARY KEY (`NewCategory_id`);

--
-- Indexes for table `tbl_automation_qtp_mcq`
--
ALTER TABLE `tbl_automation_qtp_mcq`
  ADD PRIMARY KEY (`QTP_MCQ_id`);

--
-- Indexes for table `tbl_automation_ranorex_mcq`
--
ALTER TABLE `tbl_automation_ranorex_mcq`
  ADD PRIMARY KEY (`Ranorex_MCQ_id`);

--
-- Indexes for table `tbl_automation_samplefile`
--
ALTER TABLE `tbl_automation_samplefile`
  ADD PRIMARY KEY (`SampleFile_id`);

--
-- Indexes for table `tbl_automation_selenium`
--
ALTER TABLE `tbl_automation_selenium`
  ADD PRIMARY KEY (`Selenium_id`);

--
-- Indexes for table `tbl_automation_selenium_mcq`
--
ALTER TABLE `tbl_automation_selenium_mcq`
  ADD PRIMARY KEY (`Selenium_MCQ_id`);
...
--
-- Indexes for table `tbl_candidatefinalstatus`
--
ALTER TABLE `tbl_candidatefinalstatus`
  ADD PRIMARY KEY (`user_id`);
...
--
-- Indexes for table `tbl_user_automation_mcq_result`
--
ALTER TABLE `tbl_user_automation_mcq_result`
  ADD PRIMARY KEY (`uid`);

--
-- Indexes for table `tbl_user_automation_selenium_mcq_result`
--
ALTER TABLE `tbl_user_automation_selenium_mcq_result`
  ADD PRIMARY KEY (`uid`);
...
--
-- AUTO_INCREMENT for table `tbl_automation_`
--
ALTER TABLE `tbl_automation_`
  MODIFY `_id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_automation_abc`
--
ALTER TABLE `tbl_automation_abc`
  MODIFY `ABC_id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_automation_appium_mcq`
--
ALTER TABLE `tbl_automation_appium_mcq`
  MODIFY `Appium_MCQ_id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_automation_maven_mcq`
--
ALTER TABLE `tbl_automation_maven_mcq`
  MODIFY `Maven_MCQ_id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `tbl_automation_mcq`
--
ALTER TABLE `tbl_automation_mcq`
  MODIFY `MCQ_id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tbl_automation_newcategory`
--
ALTER TABLE `tbl_automation_newcategory`
  MODIFY `NewCategory_id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `tbl_automation_qtp_mcq`
--
ALTER TABLE `tbl_automation_qtp_mcq`
  MODIFY `QTP_MCQ_id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_automation_ranorex_mcq`
--
ALTER TABLE `tbl_automation_ranorex_mcq`
  MODIFY `Ranorex_MCQ_id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `tbl_automation_samplefile`
--
ALTER TABLE `tbl_automation_samplefile`
  MODIFY `SampleFile_id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `tbl_automation_selenium`
--
ALTER TABLE `tbl_automation_selenium`
  MODIFY `Selenium_id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `tbl_automation_selenium_mcq`
--
ALTER TABLE `tbl_automation_selenium_mcq`
  MODIFY `Selenium_MCQ_id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
